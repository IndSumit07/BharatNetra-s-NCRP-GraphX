      ...
      <div className="max-w-5xl w-full relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in space-y-6">
          <div className="flex justify-center mb-8">
            <div className="w-32 h-32 bg-white border border-slate-200 rounded-3xl shadow-2xl group hover:border-cyan-500/50 transition-all duration-500 hover:scale-105 overflow-hidden">
              <img src="/logo.png" alt="BharatNetra Logo" className="w-full h-full object-cover" />
            </div>
          </div>
